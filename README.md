...
# squashinformr <a href="https://needleinthehay.ca/introducing-squashinformr/" target="_blank"><img src="man/figures/logo.png" align="right" /></a>
...
#>  8     1 Mohamed Elshorbagy Paul Coll         L              1          2         NA -     2020-02-01 Premier League 8th Rou~ ENG     N    
#>  9     1 Mohamed Elshorbagy Peter Creed       W              2          0         NA -     2020-01-01 Premier League 7th Rou~ ENG     N    
...
#> # A tibble: 388 x 15
#>    tournament_name category tournament_date round match  game player_1 player_2 game_winner player_1_score player_2_score player_1_seed
#>    <chr>           <chr>    <date>          <ord> <int> <int> <chr>    <chr>    <chr>                <dbl>          <dbl>         <dbl>
#>  1 JP Morgan Tour~ Men's    2020-01-17      F        64     4 Mohamed~ Tarek M~ Mohamed El~             11              5             2
#>  2 JP Morgan Tour~ Men's    2020-01-17      F        64     3 Mohamed~ Tarek M~ Mohamed El~             11              7             2
#>  3 JP Morgan Tour~ Men's    2020-01-17      F        64     2 Mohamed~ Tarek M~ Mohamed El~             11              7             2
#>  4 JP Morgan Tour~ Men's    2020-01-17      F        64     1 Mohamed~ Tarek M~ Tarek Momen              9             11             2
#>  5 JP Morgan Tour~ Women's  2020-01-17      F        62     3 Camille~ Nour El~ Camille Se~             11              7             5
#>  6 JP Morgan Tour~ Women's  2020-01-17      F        62     2 Camille~ Nour El~ Camille Se~             11              6             5
#>  7 JP Morgan Tour~ Women's  2020-01-17      F        62     1 Camille~ Nour El~ Camille Se~             11              8             5
#>  8 JP Morgan Tour~ Men's    2020-01-17      SF       63     5 Tarek M~ Ali Far~ Tarek Momen             11              7             4
#>  9 JP Morgan Tour~ Men's    2020-01-17      SF       63     4 Tarek M~ Ali Far~ Ali Farag                8             11             4
#> 10 JP Morgan Tour~ Men's    2020-01-17      SF       63     3 Tarek M~ Ali Far~ Ali Farag                7             11             4
#> # ... with 378 more rows, and 3 more variables: player_2_seed <dbl>, player_1_nationality <chr>, player_2_nationality <chr>
```
...
#> # A tibble: 1 x 23
#>   player_1_rank player_1 player_2_rank player_2 matches_played player_1_matche~ player_2_matche~ matches_3_2 matches_3_1 matches_3_0
#>           <int> <chr>            <int> <chr>             <int>            <int>            <int>       <int>       <int>       <int>
#> 1             5 Paul Co~             6 Diego E~              2                1                1           0           1           0
#> # ... with 13 more variables: matches_0_3 <int>, matches_1_3 <int>, matches_2_3 <int>, avg_match_time <dbl>, games_played <int>,
#> #   player_1_games_won <int>, player_2_games_won <int>, player_1_avg_advantage <dbl>, player_2_avg_advantage <dbl>, avg_point_diff <dbl>,
