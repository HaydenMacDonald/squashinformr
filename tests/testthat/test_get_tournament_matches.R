...
test_that("test get_tournament_matches for wrong input errors", {
  ...
  expect_error(squashinformr::get_tournament_matches("Black Ball Open", year = "2020-01-01", world_tour = TRUE))
  expect_error(squashinformr::get_tournament_matches("Black Ball Open", year = 2020, world_tour = "TRUE"))
...
test_that("test get_tournament_matches for proper outputs", {
  ...
  df <- squashinformr::get_tournament_matches("Black Ball Open", year = 2021, world_tour = TRUE)
